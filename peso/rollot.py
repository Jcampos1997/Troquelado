    ...
    def cerrar_canuto_primero(self):
        ...
        while 1 :
            ...
            if not data:
                ...
                consulta2 = "SELECT of_rollos FROM maquina_of where maquina='104' and estado='nuevo' order by id desc limit 1 "
                re6.execute(consulta2)
                rowse = re6.fetchall()
                re6.close()

                #extraigo el id de la máquina
                consulta_id = "SELECT id FROM maquina_of where maquina='104' and estado='nuevo' order by id desc limit 1 "
    ...
    def cerrar_rollo_ultimo(self):
        ...
        while 1 :
            ...
            if not data:
                ...
                re21 = luc.cursor()
                #cargo of a guardar en canuto
                consulta2 = "SELECT of_rollos FROM maquina_of where maquina='104' order by id desc limit 1 "
                ...
                consulta_id = "SELECT id FROM maquina_of where maquina='104' order by id desc limit 1 "
...
class Rollot(Screen):
    def __init__(self, **kwargs):
        ...
        super(Rollot, self).__init__(**kwargs)
        print('inicie')
        ...
        while 1 :
            ...
            if not data:
                ...
                for row in rowse:
                    ...
                    #SE TOMA EL PESO DEL ROLLO MENOS EL PESO DEL CANUTO
                    peso_fin = float(cd[5]) - float(peso_canuto) 
                    print('{} - {}'.format(float(cd[5]), float(peso_canuto)))
                    fecha_actual = datetime.today().strftime('%Y-%m-%d %H:%M')
    ...
    def finalizo(self):
            ...
            self.parent.current = 'finalizarz'
...
#FIN BOTONES DE MAQUINAS
        ...
        consultaop = "SELECT operador FROM maquina_of where maquina='104' order by id desc limit 1"
        ...
        if cd == None:
            ...
            consulta = "SELECT canuto,rollo FROM auditoria where of='"+ofrollo3+"' "
            print(consulta)
    ...
    def pesar_rollo_ultimo(self):
        ...
        try:
            ...
            popup = Popup(title='Rollo último',
                    content=Label(text='Último rollo pesado'),
                    size_hint=(None, None), size=(410, 150))
            popup.open()
        except:
            popup = Popup(title='Alerta',
...
#Extraigo peso CANUTO -------------------------------------------
    def extraer_pesorc(self):
        try:
            ...
            while 1 :
                ...
                if not data:
                    ...
                    for row in rowse:
                        ...
                        consulta = "INSERT into peso_canuto(fecha_creacion, ofab,codigo,peso, id_maquina_of)values ('"+dt+"','"+yytt2+"','"+codi+"','"+str(peso)+"', '"+str(id_maquina_of)+"')"
                        re7.execute(consulta)
            ...
            popup = Popup(title='Alerta',
                    content=Label(text='Error, pese canuto de nuevo!'),
                    size_hint=(None, None), size=(410, 150))
            popup.open()
        ...
        try:
            ...
            while 1 :
                ...
                if not data:
                    ...
                    consulta_id= "SELECT id FROM maquina_of where nombre='104' order by id desc limit 1 "
                    ...
                    for row in rowse:
                        ...
                        #impresion
                        re15 = luc.cursor()
                        consulta = "select a.id_peso_mat,b.of_rollos, b.maquina, b.operador, a.codrollo,a.peso from peso_materia a, maquina_of b where a.ofab=b.of_rollos and b.estado='nuevo' and b.maquina='104'  and a.finca='finca' order by id_peso_mat desc limit 1"
                        ...
                        fline4="OPERADOR: "+cd[3]
                        ftotal=fline1+fline1a+fline1b+fline1c+fline1d+fline2+fline3+fline5+fline4
                        os.remove("maquina3.txt")
                        f = open("maquina3.txt", "a+")
                        f.write(ftotal)
                        f.close()
                        os.system('lpr "maquina3.txt"')
                    ser.close()
                    break
        except:
            popup = Popup(title='Alerta',
            ...
            while 1 :
                ...
                if not data:
                    ...
                    for row in rowse:
                        ...
                        re19 = luc.cursor()
                        consulta = "INSERT into peso_desperdicio(fecha,ofab,peso, id_maquina)values ('"+dt+"','"+yytt2+"','"+str(peso)+"', '"+str(id_maquina_of)+"')"
...
#peso rollo
            ...
            while 1 :
                ...
                if not data:
                    ...
                    for row in rowse:
                        ...
                        re23 = luc.cursor() 
                        #impresion
                        consulta = "select a.id_peso_mat,b.of_rollos, b.maquina, b.operador, a.codrollo,a.peso from peso_materia a, maquina_of b where a.ofab=b.of_rollos and b.estado='nuevo' and b.maquina='104' order by id_peso_mat desc limit 1"
                        re23.execute(consulta)
                        cd = re23.fetchone()
                        ofs=cd[1]
                        re23.close()
    ...
    def printer(self):
        ...
        #cd y cds ES LA POSICION DE LOS CAMPOS AL MOMENTO DE REALIZAR
        #UNA CONSULTA SQL  
