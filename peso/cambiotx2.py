...
class Cambiotx2(Screen):
    ...
    def validar_usuario(self):
        ...
        consulta = "SELECT ordenf FROM of_troquelado where parada='2' and estado not in ('finalizado') order by id desc limit 1 "
...
Builder.load_file('cambiotx2.kv')
