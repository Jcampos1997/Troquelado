...
class ReporteCorreo103():
    ...
    def imprimirReporte(self):   
        ...
        ultima_orden_fabricacion = "SELECT ofab FROM peso_materia pm INNER JOIN maquina_of mo ON "\
                                   ...
                                   "LIKE '{}%' AND mo.maquina LIKE '%103%' ORDER BY id_peso_mat DESC limit 1 ".format(str(fecha_actual))
        ...
        #CONSULTA PARA OBTENER EL CÓDIGO DEL PRODUCTO Y EL NOMBRE DESDE SAP
