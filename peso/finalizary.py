            ...
            for row in rows:
                ...
                if uname == '' or password == '':
                    ...
                    if password == tpassword:
                        ...
                        fina = "UPDATE parada set estado='inactivo' where id_parada='2' "
                        re3.execute(fina)
                        re3.close()

                        reporte = ReporteCorreo103.ReporteCorreo103(str(uname))
                        reporte.imprimirReporte()

                        re4 = luc.cursor()
                        consulint = "SELECT ordenf from of_troquelado where parada='2' order by id desc limit 1"
...
Builder.load_file('finalizary.kv')
